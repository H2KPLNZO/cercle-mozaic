                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
                  ...
                  <div>
                    ...
                    <select value={form.anciennete} onChange={e => set("anciennete", e.target.value)} style={inp()}>
                      <option value="">—</option>
                      {["J'y pense", "Moins d'un an","1 à 5 ans","Plus de 5 ans"].map(o => <option key={o}>{o}</option>)}
                    </select>
                  </div>
                </div>
          ...
          <FadeIn>
            <div style={{ fontSize: 16, lineHeight: 2.2 }}>
              ...
              <div style={{ paddingLeft: 20, borderLeft: `1px solid ${C.dark}15`, margin: "12px 0 28px 0" }}>
                {["Le manager parfait. La leader inspirante.", "La mère présente. Le père disponible.", "La fille reconnaissante. Le fils qui gère."].map((l, i) => (
